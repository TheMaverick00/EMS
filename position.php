                            ...
                            <tr>
                                <td>
                                    ...
                                    <?php if($row1['picture']==""){
                                                ...
                                                <?php }else{?>
                                                    <a href="#" class="avatar"><img alt="" src="pictures/<?php echo $row1['picture'] ?>" width="40px" height="40px"></a>
                                              <?php  }?>
                                        <a href="profile.php">
                                            <?php echo $row['designation']  ?> </a>
                                    </h2>
                                </td>
                                <td>
                                ...
                                <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <form method="POST" action="task/edit_position.php">
                                                <div class="row">
                                                    <div class="col-sm-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input class="form-control"
                                                                value="<?php echo $row['designation']; ?>" type="text"
                                                                name="designation">
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="modal-btn delete-action">
                                                <div class="row">
                                                    <div class="col-6">
                                                        ...
                                                        <a name="delete"
                                                            href="task/delete_position.php?id=<?php echo $row['id'] ?>"
    ...
    <div id="add_employee" class="modal custom-modal fade" role="dialog">
        <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form method="POST" action="task/add_position.php">
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="form-group">
